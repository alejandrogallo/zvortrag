...
\begin{frame}{Zero phonon line (ZPL)}
  \begin{columns}
    ...
    \includegraphics[width=0.8\textwidth, trim=10em 0em 10em 0em ]{images/basic_levels_triplets.pdf}
    \end{column}
    \begin{column}{0.5\textwidth}
...
\begin{frame}{ZFS in $ \mathsf{NV}^{-} $ }
  \begin{center}
    \includegraphics[width=1.0\textwidth, trim=0 0 0em 0,clip]{images/zfs_cubic/plot_cubic.pdf}
  \end{center}
\end{frame}

%\subsection*{ZFS tensor(s) for strains}
%\subsection*{Beyond the Ground state: Using DMRG for excited state calculations}
