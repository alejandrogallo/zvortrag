...
\institute{
  ...
  %\textbf{1st examiner}: Prof. Dr. J\"org Wrachtrup\\
  %\textbf{2nd examiner}: Prof. Dr. Harald Giessen
}
  ...
  \begin{itemize}
    ...
    \item \textbf{Beyond the Ground state:}\\
      \begin{itemize}
        ...
        \item \textit{Coupled Cluster} methods for a more \textit{bulletproof} approach.
      \end{itemize}
  \end{itemize}
\end{frame}
