...
%% Element Styles
  ...
  \tikzstyle{Interested} = [fill=red!90,line width=.1mm]
  \tikzstyle{VeryInterested} = [fill=red!50,line width=.1mm]
...
% }}} Group 1 %
  ...
  \node[name=C, right of=B, Nonmetal, VeryInterested  ] {\NaturalElementTextFormat{6}{12.011}{C}{Carbon}};
  \node[name=Si, below of=C, Metalloid,Interested] {\NaturalElementTextFormat{14}{28.086}{Si}{Silicon}};
  \node[name=Ge, below of=Si, Metalloid,Interested] {\NaturalElementTextFormat{32}{72.64}{Ge}{Germanium}};
  ...
  \node[name=N, right of=C, Nonmetal,Interested] {\NaturalElementTextFormat{7}{14.007}{N}{Nitrogen}};
  \node[name=P, below of=N, Nonmetal, Interested] {\NaturalElementTextFormat{15}{30.974}{P}{Phosphorus}};
