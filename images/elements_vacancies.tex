...
%% Element Styles
  ...
  % this is to maybe change the color of everyone but some elements
  \tikzstyle{ElementControl} = [fill=gray!30]
  \tikzstyle{AlkaliMetal} = [Element, AlkaliMetalFill,ElementControl]
  \tikzstyle{AlkalineEarthMetal} = [Element, AlkalineEarthMetalFill,ElementControl]
  \tikzstyle{Metal} = [Element, MetalFill,ElementControl]
  \tikzstyle{Metalloid} = [Element, MetalloidFill,ElementControl]
  \tikzstyle{Nonmetal} = [Element, NonmetalFill,ElementControl]
  \tikzstyle{Halogen} = [Element, HalogenFill,ElementControl]
  \tikzstyle{NobleGas} = [Element, NobleGasFill,ElementControl]
  \tikzstyle{LanthanideActinide} = [Element, LanthanideActinideFill,ElementControl]
  \tikzstyle{PeriodLabel} = [font={\sffamily\LARGE}, node distance=2.0cm]
  \tikzstyle{GroupLabel} = [font={\sffamily\LARGE}, minimum width=2.75cm, node distance=2.0cm]
  \tikzstyle{TitleLabel} = [font={\sffamily\Huge\bfseries}]
  \tikzstyle{Interested} = [fill=red!00,line width=.1mm]
  \tikzstyle{VeryInterested} = [fill=red!00,line width=.1mm]
...
% }}} Group 1 %
  ...
  %\node[name=B,  Metalloid] {\NaturalElementTextFormat{5}{10.811}{B}{Boron}};
  %\node[name=Al, below of=B, Metal] {\NaturalElementTextFormat{13}{26.982}{Al}{Aluminium}};
  %\node[name=Ga, below of=Al, Metal] {\NaturalElementTextFormat{31}{69.723}{Ga}{Gallium}};
  ...
  \node[name=C, Nonmetal, VeryInterested  ] {\NaturalElementTextFormat{6}{12.011}{$ \mathsf{CV}_{\textcolor{red}a}^{\textcolor{blue}q} $}{Carbon}};
  \node[name=Si, below of=C, Metalloid,Interested] {\NaturalElementTextFormat{14}{28.086}{$ \mathsf{SiV}_{\textcolor{red}a}^{\textcolor{blue}q} $}{Silicon}};
  \node[name=Ge, below of=Si, Metalloid,Interested] {\NaturalElementTextFormat{32}{72.64}{$ \mathsf{GeV}_{\textcolor{red}a}^{\textcolor{blue}q} $}{Germanium}};
  ...
  \node[name=N, right of=C, Nonmetal,Interested] {\NaturalElementTextFormat{7}{14.007}{ $ \mathsf{NV}_{\textcolor{red}a}^{\textcolor{blue}q} $ }{Nitrogen}};
  \node[name=P, below of=N, Nonmetal, Interested] {\NaturalElementTextFormat{15}{30.974}{ $ \mathsf{PV}_{\textcolor{red}a}^{\textcolor{blue}q} $ }{Phosphorus}};
  \node[name=As, below of=P, Element, Interested] {\NaturalElementTextFormat{}{}{
    \small $\color{red}a = \left \{ c, x, z \right \} $\\
    \small $\color{blue}q = \left \{ +, -, 0 \right \} $
}{}};
  ...
  %\node[name=Uus, below of=At, Element, ElementControl] {\SyntheticElementTextFormat{117}{292}{Uus}{Ununseptium}};
...
% Diagram Title
  %\node at (C.west -| C.north) [name=diagramTitle, TitleLabel]
