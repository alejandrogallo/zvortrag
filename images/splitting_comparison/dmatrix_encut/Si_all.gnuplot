...
set title "SiV complexes"

#set format y "%.1s"

plot  \
  "data/Si_zero_cubic_128_.data" using ($3/1000):($2/1000):(sprintf("0c")) notitle with labels center font "Times,12" textcolor rgb "black"  , \
  "data/Si_zero_hexagonal_z_128_.data" using ($3/1000):($2/1000):(sprintf("0x")) notitle with labels center font "Times,12" textcolor rgb "black"  , \
...
set ytics add (703.2255/1000)



set xtics add (0.0/1000)
set ytics add (1297.23/1000)
